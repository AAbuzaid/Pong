...
# Left paddle controls are W and S keys
# Right paddles controls Up and Down keys
# http://www.codeskulptor.org/#user45_pCcivq66W3kaLGJ.py
...
# initialize ball_pos and ball_vel for a new ball in middle of table 
...
def draw(canvas):
    ...
    # draw ball and check for collisions
    ...
    # draw scores
    canvas.draw_text(str(score1), (15, 30), 30, "White")
    canvas.draw_text(str(score2), (570, 30), 30, "White")
